...
class ArtefactDescriptionSpec extends WordSpec with ShouldMatchers with OptionValues{
  ...
  "remote url" should {
    "find the remote connection url" in {
      Git.findRemoteConnectionUrl.value should (be("git@github.com:hmrc/sbt-auto-build-25.git") or be("https://github.com/hmrc/sbt-auto-build-25.git"))
    }
  }
  ...
  "create the browser url" should {
    ...
    "be created when connection url starting with 'git@'" in {
      Git.browserUrl("git@github.com:hmrc/sbt-auto-build-25") shouldBe "https://github.com/hmrc/sbt-auto-build-25"
    }

    "be created when connection url starting with 'git@' on a fork" in {
      Git.browserUrl("git@github.com:user/sbt-auto-build-25") shouldBe "https://github.com/user/sbt-auto-build-25"
    }
